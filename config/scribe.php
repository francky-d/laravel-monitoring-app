...
return [
    ...
    'description' => 'A comprehensive monitoring API for tracking application health, managing incidents, and sending notifications.',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by logging in via the <code>POST /api/auth/login</code> endpoint. Include the token in the Authorization header as <code>Bearer {token}</code>.',
    ],

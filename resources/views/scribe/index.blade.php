    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="applications">
                    <a href="#applications">Applications</a>
                                ...
                                <a href="#applications-GETapi-applications">List applications</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="applications-POSTapi-applications">
                                <a href="#applications-POSTapi-applications">Create application</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="applications-GETapi-applications--id-">
                                <a href="#applications-GETapi-applications--id-">Show application</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="applications-PUTapi-applications--id-">
                                <a href="#applications-PUTapi-applications--id-">Update application</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="applications-DELETEapi-applications--id-">
                                <a href="#applications-DELETEapi-applications--id-">Delete application</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="applications-POSTapi-applications--application_id--check">
                                <a href="#applications-POSTapi-applications--application_id--check">Trigger health check</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="applications-GETapi-applications--application_id--status">
                                <a href="#applications-GETapi-applications--application_id--status">Get application status</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="applications-GETapi-applications--application_id--subscribers">
                                <a href="#applications-GETapi-applications--application_id--subscribers">Get application subscribers</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="incidents">
                    <a href="#incidents">Incidents</a>
                                    ...
                                    <ul id="tocify-subheader-incidents" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="incidents-GETapi-incidents">
                                <a href="#incidents-GETapi-incidents">List incidents</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="incidents-POSTapi-incidents">
                                <a href="#incidents-POSTapi-incidents">Store a newly created incident.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="incidents-PUTapi-incidents--id-">
                                <a href="#incidents-PUTapi-incidents--id-">Update the specified incident.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="incidents-DELETEapi-incidents--id-">
                                <a href="#incidents-DELETEapi-incidents--id-">Remove the specified incident.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="incidents-PUTapi-incidents--incident_id--resolve">
                                <a href="#incidents-PUTapi-incidents--incident_id--resolve">Mark incident as resolved.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="incidents-PUTapi-incidents--incident_id--reopen">
                                <a href="#incidents-PUTapi-incidents--incident_id--reopen">Reopen a resolved incident.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="notification-management">
                    ...
                    <ul id="tocify-header-system-status" class="tocify-header">
                <li class="tocify-item level-1" data-unique="system-status">
                    <a href="#system-status">System Status</a>
                </li>
                                    <ul id="tocify-subheader-system-status" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="system-status-GETapi-status">
                                <a href="#system-status-GETapi-status">Get API status</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>You can retrieve your token by logging in via the <code>POST /api/auth/login</code> endpoint. Include the token in the Authorization header as <code>Bearer {token}</code>.</p>
    ...
    <p>APIs for managing applications including CRUD operations, health checks, and monitoring status.</p>

                                <h2 id="applications-GETapi-applications">List applications</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retrieve a paginated list of applications for the authenticated user.</p>
...
<i>optional</i> &nbsp;
               ...
               step="any"               name="group_id"                data-endpoint="GETapi-applications"
               value="1"
               data-component="query">
    <br>
<p>optional Filter by application group ID. Example: <code>1</code></p>
            </div>
                </form>

                    <h2 id="applications-POSTapi-applications">Create application</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Create a new application for monitoring.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The application name. Example: <code>My App</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The application URL to monitor. Example: <code>https://example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="application_group_id"                data-endpoint="POSTapi-applications"
               value="1"
               data-component="body">
    <br>
<p>optional Associate with an application group. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-applications"
               value="Production API"
               data-component="body">
    <br>
<p>optional The application description. Example: <code>Production API</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>monitoring_enabled</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
                <label data-endpoint="POSTapi-applications" style="display: none">
            <input type="radio" name="monitoring_enabled"
                   value="true"
                   data-endpoint="POSTapi-applications"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-applications" style="display: none">
    ...
    <br>
<p>optional Enable monitoring for this application. Example: <code>true</code></p>
        </div>
        </form>

                    <h2 id="applications-GETapi-applications--id-">Show application</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retrieve detailed information about a specific application.</p>
...
<p>The application ID. Example: <code>1</code></p>
                    ...
                    <h2 id="applications-PUTapi-applications--id-">Update application</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Update the specified application's information.</p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="application"                data-endpoint="PUTapi-applications--id-"
               value="1"
               data-component="url">
    <br>
<p>The application ID. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional The application name. Example: <code>Updated App</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>url</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional The application URL. Example: <code>https://updated-example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>url_to_watch</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="application_group_id"                data-endpoint="PUTapi-applications--id-"
               value="2"
               data-component="body">
    <br>
<p>optional Change application group. Example: <code>2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-applications--id-"
               value="Updated description"
               data-component="body">
    <br>
<p>optional The application description. Example: <code>Updated description</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>monitoring_enabled</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
                <label data-endpoint="PUTapi-applications--id-" style="display: none">
            <input type="radio" name="monitoring_enabled"
                   value="true"
                   data-endpoint="PUTapi-applications--id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-applications--id-" style="display: none">
    ...
    <br>
<p>optional Enable/disable monitoring. Example: <code>false</code></p>
        </div>
        </form>

                    <h2 id="applications-DELETEapi-applications--id-">Delete application</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Delete the specified application. This action cannot be undone.</p>
...
<p>The application ID. Example: <code>1</code></p>
                    ...
                    <h2 id="applications-POSTapi-applications--application_id--check">Trigger health check</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Manually trigger a health check for the specified application.</p>
...
<form id="form-POSTapi-applications--application_id--check" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-applications--application_id--check');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-applications--application_id--check"
                    onclick="cancelTryOut('POSTapi-applications--application_id--check');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="application"                data-endpoint="POSTapi-applications--application_id--check"
               value="1"
               data-component="url">
    <br>
<p>The application ID. Example: <code>1</code></p>
                    ...
                    <h2 id="applications-GETapi-applications--application_id--status">Get application status</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Get the current monitoring status and recent incident information for an application.</p>
...
<form id="form-GETapi-applications--application_id--status" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-applications--application_id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-applications--application_id--status"
                    onclick="cancelTryOut('GETapi-applications--application_id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="application"                data-endpoint="GETapi-applications--application_id--status"
               value="1"
               data-component="url">
    <br>
<p>The application ID. Example: <code>1</code></p>
                    ...
                    <h2 id="applications-GETapi-applications--application_id--subscribers">Get application subscribers</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retrieve all users subscribed to notifications for this application.</p>
...
<form id="form-GETapi-applications--application_id--subscribers" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-applications--application_id--subscribers');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-applications--application_id--subscribers"
                    onclick="cancelTryOut('GETapi-applications--application_id--subscribers');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="application"                data-endpoint="GETapi-applications--application_id--subscribers"
               value="1"
               data-component="url">
    <br>
<p>The application ID. Example: <code>1</code></p>
...
<form id="form-DELETEapi-application-groups--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-application-groups--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-application-groups--id-"
                    onclick="cancelTryOut('DELETEapi-application-groups--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-application-groups--applicationGroup_id--applications" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-application-groups--applicationGroup_id--applications');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-application-groups--applicationGroup_id--applications"
                    onclick="cancelTryOut('POSTapi-application-groups--applicationGroup_id--applications');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi-application-groups--applicationGroup_id--applications--application_id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-application-groups--applicationGroup_id--applications--application_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-application-groups--applicationGroup_id--applications--application_id-"
                    onclick="cancelTryOut('DELETEapi-application-groups--applicationGroup_id--applications--application_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the subscription. Example: <code>architecto</code></p>
    ...
    <p>APIs for managing incidents including creation, listing, updates, and status changes.</p>

                                <h2 id="incidents-GETapi-incidents">List incidents</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retrieve a paginated list of incidents for applications owned by the authenticated user.</p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="application_id"                data-endpoint="GETapi-incidents"
               value="1"
               data-component="query">
    <br>
<p>optional Filter by application ID. Example: <code>1</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>optional Filter by status (open, resolved, investigating). Example: <code>open</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>optional Filter by severity (low, medium, high, critical). Example: <code>high</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="start_date"                data-endpoint="GETapi-incidents"
               value="2024-01-01"
               data-component="query">
    <br>
<p>optional Filter incidents after this date. Example: <code>2024-01-01</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="end_date"                data-endpoint="GETapi-incidents"
               value="2024-12-31"
               data-component="query">
    <br>
<p>optional Filter incidents before this date. Example: <code>2024-12-31</code></p>
            </div>
                </form>

                    <h2 id="incidents-POSTapi-incidents">Store a newly created incident.</h2>
...
<i>optional</i> &nbsp;
               ...
               value="2025-08-22T09:20:27"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-08-22T09:20:27</code></p>
        </div>
        </form>

                    <h2 id="incidents-PUTapi-incidents--id-">Update the specified incident.</h2>
...
<form id="form-PUTapi-incidents--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-incidents--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-incidents--id-"
                    onclick="cancelTryOut('PUTapi-incidents--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Must be a valid date. Example: <code>2025-08-22T09:20:27</code></p>
                    ...
                    <h2 id="incidents-DELETEapi-incidents--id-">Remove the specified incident.</h2>
...
<form id="form-DELETEapi-incidents--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-incidents--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-incidents--id-"
                    onclick="cancelTryOut('DELETEapi-incidents--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the incident. Example: <code>architecto</code></p>
                    ...
                    <h2 id="incidents-PUTapi-incidents--incident_id--resolve">Mark incident as resolved.</h2>
...
<form id="form-PUTapi-incidents--incident_id--resolve" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-incidents--incident_id--resolve');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-incidents--incident_id--resolve"
                    onclick="cancelTryOut('PUTapi-incidents--incident_id--resolve');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the incident. Example: <code>architecto</code></p>
                    ...
                    <h2 id="incidents-PUTapi-incidents--incident_id--reopen">Reopen a resolved incident.</h2>
...
<form id="form-PUTapi-incidents--incident_id--reopen" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-incidents--incident_id--reopen');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-incidents--incident_id--reopen"
                    onclick="cancelTryOut('PUTapi-incidents--incident_id--reopen');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-user-notification-settings" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-user-notification-settings');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-user-notification-settings"
                    onclick="cancelTryOut('GETapi-user-notification-settings');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PUTapi-user-notification-settings" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-user-notification-settings');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-user-notification-settings"
                    onclick="cancelTryOut('PUTapi-user-notification-settings');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-user-test-notification--type-" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-user-test-notification--type-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-user-test-notification--type-"
                    onclick="cancelTryOut('POSTapi-user-test-notification--type-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-user-notification-history" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-user-notification-history');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-user-notification-history"
                    onclick="cancelTryOut('GETapi-user-notification-history');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for checking system status and health.</p>

                                <h2 id="system-status-GETapi-status">Get API status</h2>

<p>
</p>

<p>Check if the API is running and get basic system information.</p>
